...
class PreProcessorGlyph(TemplateBasePreProcessor, ProtocolTemplatePreProcessor):
    ...
    def _get_file_name(self) -> str:
        return "process_glyph_registry.py"

    def _get_content(self) -> str:
        return """from typing import Any, cast


class ProcessGlyphRegistry:
    ...
    def get_template_type(self) -> str:
        ...
        if not tt == "glyph":
            raise ValueError(f"Invalid template_type: {tt}. Expected 'glyph'.")
        return tt
    ...
    def process(self) -> dict[str, Any]:
        \"\"\"Main processing method to format the glyph registry.\"\"\"
        self._process_reg()
