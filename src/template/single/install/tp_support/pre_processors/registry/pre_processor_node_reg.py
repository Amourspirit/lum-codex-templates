...
class PreProcessorNodeReg(TemplateBasePreProcessor, ProtocolTemplatePreProcessor):
    ...
    def _get_file_name(self) -> str:
        return "process_node_reg_registry.py"

    def _get_content(self) -> str:
        return """from typing import Any, cast


class ProcessNodeRegRegistry:
    ...
    def get_template_type(self) -> str:
        ...
        if not tt == "node_reg":
            raise ValueError(f"Invalid template_type: {tt}. Expected 'node_reg'.")
        return tt
    ...
    def process(self) -> dict[str, Any]:
        \"\"\"Main processing method to format the node_reg registry.\"\"\"
        self._process_reg()
