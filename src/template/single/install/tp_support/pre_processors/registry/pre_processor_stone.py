...
class PreProcessorStone(TemplateBasePreProcessor, ProtocolTemplatePreProcessor):
    ...
    def _get_file_name(self) -> str:
        return "process_stone_registry.py"

    def _get_content(self) -> str:
        return """from typing import Any, cast


class ProcessStoneRegistry:
    ...
    def get_template_type(self) -> str:
        ...
        if not tt == "stone":
            raise ValueError(f"Invalid template_type: {tt}. Expected 'stone'.")
        return tt
    ...
    def process(self) -> dict[str, Any]:
        \"\"\"Main processing method to format the stone registry.\"\"\"
        self._process_reg()
