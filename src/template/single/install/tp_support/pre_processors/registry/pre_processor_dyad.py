...
class PreProcessorDyad(TemplateBasePreProcessor, ProtocolTemplatePreProcessor):
    ...
    def _get_file_name(self) -> str:
        return "process_dyad_registry.py"

    def _get_content(self) -> str:
        return """from typing import Any, cast


class ProcessDyadRegistry:
    ...
    def get_template_type(self) -> str:
        ...
        if not tt == "dyad":
            raise ValueError(f"Invalid template_type: {tt}. Expected 'dyad'.")
        return tt
    ...
    def process(self) -> dict[str, Any]:
        \"\"\"Main processing method to format the dyad registry.\"\"\"
        self._process_reg()
