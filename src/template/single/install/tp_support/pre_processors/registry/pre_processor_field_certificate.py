...
class PreProcessorFieldCertificate(
    ...
    def _get_file_name(self) -> str:
        return "process_field_certificate_registry.py"

    def _get_content(self) -> str:
        return """from typing import Any, cast


class ProcessFieldCertificateRegistry:
    ...
    def get_template_type(self) -> str:
        ...
        if not tt == "field_certificate":
            raise ValueError(
                f"Invalid template_type: {tt}. Expected 'field_certificate'."
            )
        return tt
    ...
    def process(self) -> dict[str, Any]:
        \"\"\"Main processing method to format the field_certificate registry.\"\"\"
        self._process_reg()
