...
class PreProcessorLinkageScroll(TemplateBasePreProcessor, ProtocolTemplatePreProcessor):
    ...
    def _get_file_name(self) -> str:
        return "process_linkage_scroll_registry.py"

    def _get_content(self) -> str:
        return """from typing import Any, cast


class ProcessLinkageScrollRegistry:
    ...
    def get_template_type(self) -> str:
        ...
        if not tt == "linkage_scroll":
            raise ValueError(f"Invalid template_type: {tt}. Expected 'linkage_scroll'.")
        return tt
    ...
    def process(self) -> dict[str, Any]:
        \"\"\"Main processing method to format the linkage_scroll registry.\"\"\"
        self._process_reg()
