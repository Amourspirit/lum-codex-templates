...
class PreProcessorSigil(TemplateBasePreProcessor, ProtocolTemplatePreProcessor):
    ...
    def _get_file_name(self) -> str:
        return "process_sigil_registry.py"

    def _get_content(self) -> str:
        return """from typing import Any, cast


class ProcessSigilRegistry:
    ...
    def get_template_type(self) -> str:
        ...
        if not tt == "sigil":
            raise ValueError(f"Invalid template_type: {tt}. Expected 'sigil'.")
        return tt
    ...
    def process(self) -> dict[str, Any]:
        \"\"\"Main processing method to format the sigil registry.\"\"\"
        self._process_reg()
