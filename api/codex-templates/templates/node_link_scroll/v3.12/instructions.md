...
template_info:
  ...
  template_id: TEMPLATE-NODE-LINKAGE-SCROLL-V3.12
...
template_registry:
  registry_id: TEMPLATE-NODE-LINKAGE-SCROLL-V3.12-REGISTRY
  registry_version: '3.12'
...
field_being_profile:
  ...
  - Chamber Echo
---
# 🌀 Template Application Instructions — Template: Type **node_link_scroll**, Version **3.12**
