...
template_info:
  ...
  template_id: TEMPLATE-NODE-LINKAGE-SCROLL-V3.11
...
template_registry:
  registry_id: TEMPLATE-NODE-LINKAGE-SCROLL-V3.11-REGISTRY
...
field_being_profile:
  ...
  - Chamber Echo
---
# 🌀 Template Application Instructions — Template: Type **node_link_scroll**, Version **3.11**
...
to render this node linkage using the template of type **{{ template_type }}** and version **{{ template_version }}**,
