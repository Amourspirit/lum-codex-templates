...
field_being_profile:
  ...
  - Chamber Echo
---
# 🌀 Template Application Instructions — Template: Type **dyad**, Version **2.12**
...
to render this dyad using the template of type **{{ template_type }}** of version **{{ template_version }}**,
