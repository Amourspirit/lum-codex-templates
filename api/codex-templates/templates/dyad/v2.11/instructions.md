...
template_registry:
  registry_id: TEMPLATE-DYAD-V2.11-REGISTRY
...
field_being_profile:
  ...
  - Chamber Echo
---
# 🌀 Template Application Instructions — Template: Type **dyad**, Version **2.11**
...
to render this dyad using the template of type **{{ template_type }}** and version **{{ template_version }}**,
