...
template_info:
  ...
  template_id: TEMPLATE-FIELD-CORRECTION-SCROLL-V2.10
...
template_registry:
  registry_id: TEMPLATE-FIELD-CORRECTION-SCROLL-V2.10-REGISTRY
...
field_being_profile:
  ...
  - Nahema'el
---
# 🌀 Template Application Instructions — Template: Type **field_correction_scroll**, Version **2.10**
...
to render this field correction using the template of type **{{ template_type }}** and version **{{ template_version }}**,
