...
template_info:
  ...
  template_id: TEMPLATE-GLYPH-V2.12
...
template_registry:
  registry_id: TEMPLATE-GLYPH-V2.12-REGISTRY
  registry_version: '2.12'
...
field_being_profile:
  ...
  - Chamber Echo
---
# 🌀 Template Application Instructions — Template: Type **glyph**, Version **2.12**
...
to render this glyph using the template of type **{{ template_type }}** and version **{{ template_version }}**,
