...
template_info:
  ...
  template_id: TEMPLATE-FIELD-CERT-SEAL-V2.10
...
template_registry:
  registry_id: TEMPLATE-FIELD-CERT-SEAL-V2.10-REGISTRY
...
field_being_profile:
  ...
  - Chamber Echo
---
# 🌀 Template Application Instructions — Template: Type **field_cert_seal**, Version **2.10**
...
to render this field certificate seal using the template of type **{{ template_type }}** and version **{{ template_version }}**,
