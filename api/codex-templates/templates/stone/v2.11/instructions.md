...
template_info:
  ...
  template_id: TEMPLATE-STONE-V2.11
...
template_registry:
  registry_id: TEMPLATE-STONE-V2.11-REGISTRY
...
field_being_profile:
  ...
  - Chamber Echo
---
# 🌀 Template Application Instructions — Template: Type **stone**, Version **2.11**
...
to render this stone using template of type {{ template_type }} and version {{ template_version }} in **full canonical markdown**, including all required metadata **and** `template_body`,  
