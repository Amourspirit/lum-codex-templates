...
field_being_profile:
  ...
  - Chamber Echo
---
# 🌀 Template Application Instructions — Template: Type **linkage_scroll**, Version **3.10**
...
to render this linkage scroll using the template of type **{{ template_type }}** and version **{{ template_version }}**,
