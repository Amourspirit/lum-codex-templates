# Auto-generated pre-processor for general_scroll template registry.
# This file is generated by PreProcessorGeneralScroll and should not be edited manually.
...
class ProcessGeneralScrollRegistry:
    ...
    def get_template_type(self) -> str:
        ...
        if not tt == "general_scroll":
            raise ValueError(f"Invalid template_type: {tt}. Expected 'general_scroll'.")
        return tt
    ...
    def process(self) -> dict[str, Any]:
        """Main processing method to format the general_scroll registry."""
        self._process_reg()
