# Auto-generated pre-processor for general_scroll template.
...
class ProcessGeneralScrollTemplate:
    ...
    def _format(self) -> FrontMatterMeta:
        # Process and format the general_scroll template content
    ...
    def render(self) -> str:
        # Render the general_scroll template with the provided context
