# Auto-generated pre-processor for field_certificate template registry.
# This file is generated by PreProcessorFieldCertificate and should not be edited manually.
...
class ProcessFieldCertificateRegistry:
    ...
    def get_template_type(self) -> str:
        ...
        if not tt == "field_certificate":
            raise ValueError(f"Invalid template_type: {tt}. Expected 'field_certificate'.")
        return tt
